...
### $\color{purple}{\mathbf{-c,--compare_trees}}$
### $\color{purple}{\mathbf{-c, --compare_trees}}$
### $\color{purple}{\mathsf{-c, --compare_trees}}$
### $\color{purple}{\mathrm{-c, --compare_trees}}$
### $\color{purple}{\mathit{-c, --compare_trees}}$
### $\color{purple}{\mathtt{-c, --compare_trees}}$
