...
### $\color{purple}{\texttt{-v, --verbose}}$
> Do not remove the intermediate files generated by GPT
    
        
### $\color{purple}{\texttt{-p PLOTFILE, --plot PLOTFILE}}$ 
> Create an MDS plot from the generated distances
                        
    
### $\color{purple}{\texttt{-n NUMPATHTREES, --np NUMPATHTREES, --numpathtrees NUMPATHTREES}}$
> Number of trees along the path between two initial trees
                        
    
### $\color{purple}{\texttt{-b NUMBESTTREES, --best NUMBESTTREES, --numbesttrees NUMBESTTREES}}$
> Number of trees selected from the best likliehood trees for the next round of refinement
                        
    
### $\color{purple}{\texttt{-r NUM_RANDOM_TREES, --randomtrees NUM_RANDOM_TREES}}$
> Generate num_random_trees rooted trees using the sequence data individual names.
                        
    
### $\color{purple}{\texttt{-g OUTGROUP, --outgroup OUTGROUP}}$
> Forces an outgroup when generating random trees.
                        
    
### $\color{purple}{\texttt{-i NUM_ITERATIONS, --iterate NUM_ITERATIONS}}$
...
### $\color{purple}{\texttt{-e, --extended}}$
> If the phylip dataset is in the extended format, use this.
    
    
### $\color{purple}{\texttt{-hull, --convex_hull}}$
...
### $\color{purple}{\texttt{-gtp, --gtp_distance}}$
...
### $\color{purple}{\mathbf{-c,--compare\_trees}}$
### $\color{purple}{\mathbf{-c, --compare\_trees}}$
### $\color{purple}{\mathsf{-c, --compare\_trees}}$
### $\color{purple}{\mathrm{-c, --compare\_trees}}$
### $\color{purple}{\mathit{-c, --compare\_trees}}$
### $\color{purple}{\mathtt{-c, --compare\_trees}}$
...
### $\color{purple}{\texttt{-interp, --interpolate}}$
